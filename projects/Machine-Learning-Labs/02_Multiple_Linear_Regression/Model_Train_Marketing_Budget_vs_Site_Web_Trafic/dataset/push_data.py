...
budget_marketing_visiteurs = push_data_to_sql('../dataset/budget_marketing_visiteurs/budget_marketing_visiteurs.csv', "budget_marketing_visiteurs")


if __name__ == "__main__":
    from config.settings import *
    budget_marketing_visiteurs = push_data_to_sql('budget_marketing_visiteurs/budget_marketing_visiteurs.csv', "budget_marketing_visiteurs")
