...
# need to put my real column in the schema not yet done ( later please)
expected_schema = {
...
if __name__ == "__main__":
    ...
    relation_dict = validate_data_type_and_range(fech_data_from_psql(engine),expected_schema)
    print(relation_dict)
