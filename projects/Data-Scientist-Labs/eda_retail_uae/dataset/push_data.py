...
NOTE : certifi fichier n'est pas utiliser car on ne pousse rien a psql dans ce project ci
...
#             table_name = os.path.splitext(os.path.basename(csv_filepath))[
#                 0]  # la sortie ici sera juste le nom de la table sans extension ".csv"
...
# category_translation = push_data_to_sql('../dataset/E_commerce_datasets/category_translation.csv',
